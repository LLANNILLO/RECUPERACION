...
class AnimalController extends Controller
{
    ...
    private $animales = array(
        array(
            ...
            El carácter del bisonte se modifica con el paso de los años: de joven es alegre y vivaz y, aunque no es especialmente manso, tampoco se muestran agresivos.
            Al hacerse viejos, sobre todo los machos, se vuelven rudos y se irritan fácilmente, llegando a ser peligrosos.'
        ),
        array(
            'especie' => 'Elefante',
            'peso' => 5000,
     ...
     */
    public function show(int $posicion_animal)
    {
        $animal =$this->animales[$posicion_animal];
